...
<div  class="bg-gray-100 flex items-center justify-center h-screen" id="register">
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-sm w-full">
        ...
        <h2 class="text-2xl font-semibold text-center mb-4">Edite info user</h2>
        ...
        <form action="index.php?page=edit" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" id="email" class="form-input w-full px-4 py-2 border rounded-lg text-gray-700 focus:ring-blue-500" required placeholder="entre email" value="<?php echo $row['email']; ?>">
            </div>
            <div class="mb-6">
            ...
            <button type="submit" name="send" class="w-full bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">Edit</button>
